...
- App and master registry: `~/thought-os/`
- Vault file: `~/thought-os/config/session.vault`
- Notebook data: `~/thought-os/notebooks_root/`

All components on the same machine. Simplest deployment.

### 5.2 USB‑Based Portable Operation

- App and master registry: `/mnt/usb/thought-os/`
- Vault file: `/mnt/usb/thought-os/config/session.vault`
...
- App and master registry: `/mnt/usb1/thought-os/`
