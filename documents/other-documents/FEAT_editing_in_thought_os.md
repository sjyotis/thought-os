...
Editing in Thought OS is not a feature. It is the core activity. The system provides two modes (internal and external) to adapt to the user's context. It preserves syntax highlighting for file notes. It protects work with autosave, recovery, and atomic writes. It allows export without lock‑in. It provides timeline access to every past version.
